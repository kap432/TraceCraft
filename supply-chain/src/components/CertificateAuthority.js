...
const CertificateAuthority = () => {
  ...
  const signCertificateDetails = async () => {
    try {
      ...
      const privateKey = "0x055c2aec0e4301f6d8814b3747a9d509fb3c6f60905f7297813ebd3f53c9ddf8"; // Replace with the actual private key (store securely).
  ...
  const uploadToPinata = async (file) => {
    ...
    try {
      ...
      await contract.methods.certifyProduct(productId, certificateProvider, digitalSignature, uploadedDocHash).send({ from: walletAddress });
