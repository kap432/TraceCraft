...
const AddProduct = () => {
  ...
  useEffect(() => {
    const autoConnectMetaMask = async () => {
      if (window.ethereum) {
        try {
          // Request account access automatically when the component mounts
          ...
          const contractAddress = "0x5518F881c4a20D86Ec92CD46e22a5e35621fB1d9"; // Replace with actual contract address
        const contractABI = [
          {
            anonymous: false,
            inputs: [
